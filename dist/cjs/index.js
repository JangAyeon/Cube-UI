...
const Button = react.forwardRef(({ colorTheme = "primary", size = "md", variants = "solid", shape = "square", isDisabled = false, isLoading = false, children, className, ...htmlProps }, ref) => {
    ...
    return (jsxRuntime.jsx("button", { ref: ref, className: clsx(COLOR_THEMES$1[colorTheme][variants ?? "solid"], BUTTON_SIZES[size], BUTTON_SHAPES[shape], (isDisabled || isLoading) && "cursor-not-allowed opacity-50", className), disabled: isDisabled || isLoading, ...htmlProps, children: children }));
});
...
const Input = react.forwardRef(({ width = "w-full", height = "h-[4.8rem]", className, isDisabled = false, ...htmlProps }, ref) => {
    console.log(clsx(width, height, isDisabled, className));
    return (jsxRuntime.jsx("input", { ref: ref, className: clsx(BASE, TEXT_STYLE, BORDER_STYLE, INTERACTION, PLACEHOLDER_STYLE, DISABLED_STYLE, width, height, className), disabled: isDisabled, ...htmlProps }));
});
...
const Chip = react.forwardRef(({ colorTheme = "primary", size = "md", shape = "square", children, className, ...htmlProps }, ref) => {
    /* console.log(
      clsx(
        COLOR_THEMES[colorTheme][variants ?? "solid"],
        BUTTON_SIZES[size],
    ...
    return (jsxRuntime.jsx("div", { ref: ref, className: clsx(COLOR_THEMES[colorTheme], CHIP_SIZES[size], CHIP_SHAPES[shape], className), ...htmlProps, children: children }));
});

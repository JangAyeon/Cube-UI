...
const Button = react.forwardRef(({ colorTheme = "primary", size = "md", variants = "solid", shape = "square", isDisabled = false, isLoading = false, children, className, ...htmlProps }, ref) => {
    ...
    return (jsxRuntime.jsx("button", { ref: ref, className: clsx(COLOR_THEMES[colorTheme], VARIANT_STYLES[variants], BUTTON_SIZES[size], BUTTON_SHAPES[shape], (isDisabled || isLoading) && "cursor-not-allowed opacity-50", className), disabled: isDisabled || isLoading, ...htmlProps, children: children }));
});
